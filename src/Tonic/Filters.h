...
#pragma mark - Core Generators
  ...
  namespace Tonic_ {
    ...
    protected:
      ...
      virtual void applyFilter( TonicFloat cutoff, TonicFloat Q,  const TonicContext_ & context ) = 0;
    ...
    inline void Filter_::computeOutput( const TonicContext_ & context ){
    ...
    protected:
      inline void applyFilter( TonicFloat cutoff, TonicFloat Q, const TonicContext_ & context )
      {
...
#pragma mark - Smart Pointers
  ...
  public:
    ...
    TONIC_GENERATOR_SETTERS(FilterType, cutoff, setCutoff);
    TONIC_GENERATOR_SETTERS(FilterType, Q, setQ);
