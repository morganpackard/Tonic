...
#pragma mark - Internal State setters
  ...
  public:
    ...
    */
    TONIC_CONTROL_GENERATOR_SETTERS(RampedValue, target, setTargetGen);
    ...
    */
    TONIC_CONTROL_GENERATOR_SETTERS(RampedValue, length, setLengthGen);
    ...
    */
    TONIC_CONTROL_GENERATOR_SETTERS(RampedValue, value, setValueGen);
