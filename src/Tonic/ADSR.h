...
namespace Tonic {
  ...
  namespace Tonic_ {
    ...
    inline void ADSR_::computeOutput(const TonicContext_ &context){
  ...
  */
  ...
  class ADSR : public TemplatedGenerator<Tonic_::ADSR_>{
    ...
    public:
      ...
      TONIC_CONTROL_GENERATOR_SETTERS(ADSR, trigger, setTrigger);
      TONIC_CONTROL_GENERATOR_SETTERS(ADSR, attack, setAttack);
      TONIC_CONTROL_GENERATOR_SETTERS(ADSR, decay, setDecay);
      TONIC_CONTROL_GENERATOR_SETTERS(ADSR, sustain, setSustain);
      TONIC_CONTROL_GENERATOR_SETTERS(ADSR, release, setRelease);
      TONIC_CONTROL_GENERATOR_SETTERS(ADSR, exponential, setIsExponential);
      TONIC_CONTROL_GENERATOR_SETTERS(ADSR, doesSustain, setDoesSustain);
      TONIC_CONTROL_GENERATOR_SETTERS(ADSR, legato, setIsLegato);
