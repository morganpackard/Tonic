...
namespace Tonic {
  ...
  namespace Tonic_{
    ...
    inline void Adder_::computeOutput( const TonicContext_ &context ){
  ...
  namespace Tonic_ {
    ...
    inline void Subtractor_::computeOutput(const TonicContext_ &context){
  ...
  namespace Tonic_{
    ...
    inline void Multiplier_::computeOutput( const TonicContext_ & context ){
  ...
  namespace Tonic_ {
    ...
    inline void Divider_::computeOutput(const TonicContext_ &context){
      left.tick(outputFrames_, context);
      right.tick(workSpace, context);
      outputFrames_ /= workSpace;
