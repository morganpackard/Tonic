...
namespace Tonic_{
  ...
  */
  ...
  public:
    TONIC_CONTROL_GENERATOR_SETTERS(ControlRandom, max, setMax)
    TONIC_CONTROL_GENERATOR_SETTERS(ControlRandom, min, setMin)
    TONIC_CONTROL_GENERATOR_SETTERS(ControlRandom, trigger, setTrigger)
  };
